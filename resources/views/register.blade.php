          ...
          <div class="col-xl-5 col-lg-6 col-md-8">
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
              ...
              <div class="card-header text-center py-4 border-0" style="background-color: var(--accent-color);">
                <h3 class="mb-0 text-white fw-bold" style="font-family: 'Comfortaa', sans-serif;">Registro</h3>
              </div>

              <div class="card-body p-4 p-md-5">

                {{-- Ajusta la ruta a tu controlador Laravel --}}
                <form action="{{ route('register') }}" method="POST" class="needs-validation" novalidate>
                  @csrf
                  
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" name="email" id="email" placeholder="admin@kds.com" required>
                  ...
                  <div class="form-floating mb-4">
                    <input type="password" class="form-control" name="password_confirmation" id="password_confirm" placeholder="Confirm Password" required>
                    <label for="password_confirm" class="text-muted">Confirmar Contraseña</label>
                ...
                <div class="text-center mt-4 pt-2 border-top">
                  ...
                  <a href="{{ route('login') }}" class="fw-bold text-decoration-none" style="color: var(--heading-color);">
                    Inicia Sesión
                  </a>
                </div>
